...
So the last check is mainly:

An early failure check.
A way to maintain the invariant that the heap contains exactly the values still available.
A way to make sure heappop() removes the intended value.
"""
