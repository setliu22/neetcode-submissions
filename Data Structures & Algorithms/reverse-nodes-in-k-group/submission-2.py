# THERE IS GROUP PREV GROUP NEXT AND ALSO PREV AND NEXT WHERE YOU HAVE TO IMPLEMENT THE NORMAL REVERSAL LOGIC
# temp = curr.next (Save the next node before breaking the link)
# THEN, prev = curr, curr = temp

# Then continue, temp = curr.next, curr.next = prev
    ...
    def reverseKGroup(self, head: Optional[ListNode], k: int) -> Optional[ListNode]:
        ...
        while True:
            ...
            for _ in range(k):
                ...
                # Dummy.next is the correct 'head'
                if not kth:
                    return dummy.next
