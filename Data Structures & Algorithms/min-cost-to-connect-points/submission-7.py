...
prim's choice can never raise costs
It is optimal because you can just take another optimal tree and replace edges until you have prim's tree
and since starting tree was optimal, prim's tree is optimal
